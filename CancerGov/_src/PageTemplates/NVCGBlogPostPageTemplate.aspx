<!--(bake Includes/TemplateIntro.inc template_name="NVCGBlogPostPageTemplate.aspx" skipto_id="main")-->
                ...
                <div class="row">                    
                    ...
                    <div class="medium-9 columns contentzone" id="main" tabindex="0" role="main">
                        ...
                        <article>
                            ...
                            <!--(bake includes/ArticleFooter.inc citations="true" related_resources="true" pagination="true" comments="true" blog_feature_cards="true")-->
                        </article>
                        <!-- ********************************* END Page Content ********************************** -->
                    </div> <!-- END Main -->

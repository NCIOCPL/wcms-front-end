define(function() {
	...
	// Helper function used to filter out videos that are part of a carousel
	const checkNodeAncestryForClass = (node, className) => {
	...
	const injectPreviewContents = parent => {
		...
		// Using innerHTML for expediency (and to avoid possible issues with createElementNS() compatibility)
		...
		parent.addEventListener('click', () => injectIFrame(parent, videoId, videoTitle), false)
	}

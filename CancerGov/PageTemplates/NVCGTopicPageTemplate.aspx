...
88888888888  .d88888b.  8888888b.  8888888  .d8888b.
    ...
    888      "Y88888P"  888        8888888  "Y8888P"
        ...
        <div class="fixedtotop">
            <div class="headroom-area">
                ...
                <div class="language-bar">
                    <NCI:LanguageToggleControl ID="LangList1" CssClass="row sitewide-language" runat="server">
            ...
            <div class="row general-page-body-container collapse">
                ...
                <div class="row">
                    ...
                    <div class="medium-9 columns contentzone" id="main" tabindex="1" role="main">
                        ...
                        <article>
                            <!-- BANNER SLOT -->
                            <NCI:TemplateSlot ID="cgvBodyHeader" runat="server" CssClass="row banner-slot" AdditionalSnippetClasses="large-12 columns body-banner" />
                            <!-- END BANNER SLOT -->
                            <!-- PAGE TITLE -->
